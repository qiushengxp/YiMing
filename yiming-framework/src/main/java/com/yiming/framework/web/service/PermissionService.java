package com.yiming.framework.web.service;
...
public class PermissionService {
    ...
    {
        return isPermitted(permission) ? "" : NOACCESS;
    }
    ...
    {
        return isLacksPermitted(permission) ? "" : NOACCESS;
    }
    ...
    {
        return hasAnyPermissions(permissions, PERMISSION_DELIMETER) ? "" : NOACCESS;
    }
    ...
    {
        return isLacksRole(role) ? "" : NOACCESS;
    }
    ...
    {
        return isAnyRoles(roles, ROLE_DELIMETER) ? "" : NOACCESS;
    }
