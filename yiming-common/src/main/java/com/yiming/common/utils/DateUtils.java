package com.yiming.common.utils;
...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    public static Long parseTimestamp(Date date) {
        ...
        return ts.getDateTime() / 1000;     // 使用秒
    }
    ...
    public static String parseTimestampToStr(Long timestamp) {
        return parseDateToStr(YYYY_MM_DD_HH_MM_SS, parseTimestampToDate(timestamp));
    }
